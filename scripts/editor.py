...
def cut_video(start_time, video_path):
    print("Cutting video", video_path)
    command = [
        './ffmpeg',
        '-y',
        '-ss', start_time,
    ...
    ffmpeg_command = [
        ...
        '-vf', 'scale=-1:2560, crop=1080:1920',
        # '-vf', 'crop=1440:2560',
        '-c:a', 'copy',
        CUTED_PART_OF_VIDEO
    ]
...
def create_short(title, genre, video_path):
    ...
    if not is_folder_empty(song_folder):
...
def main():
    parser = argparse.ArgumentParser(description='abaju')
    parser.add_argument('--start', required=True,
                        help='The start time of the short')
    parser.add_argument('--title', required=True,
                        help='Title of the short')
    parser.add_argument('--genre', required=True,
                        help='Genre of the short')
    parser.add_argument('--videoName', required=True,
